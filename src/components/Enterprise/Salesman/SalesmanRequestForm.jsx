...
const SalesmanFormPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      //clear all the feilds after submission
      setFormData({
        first_name: "",
        last_name: "",
        email: "",
      ...
      console.error("Error submitting the salesman request form", error);
    }
  };
      ...
      <div className="w-full h-auto">
        <div className="max-w-5xl mx-auto py-16 px-6 lg:px-8 text-center">
          ...
          <p className="mt-4 text-lg text-gray-600">
            Join us and take the next step in your sales career! Help us expand
            the market and reach new clients with your skills and passion.
          </p>
        </div>
